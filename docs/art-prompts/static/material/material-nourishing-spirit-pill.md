...
| Field | Value |
|---|---|
| Asset ID | `material.nourishing_spirit_pill` |
| Category | `material` |
| Output | `768 × 768` `transparent` PNG |
| Project target | `res://assets/materials/nourishing-spirit-pill.png` |
...
Composition:
A single high-tier mind essence centered in a transparent square canvas. Use one main pearl, a soft petal-like cradle, and one restrained orbit band. Keep every element attached or closely nested so the image remains stable for small-size display.

Object and material design:
A luminous but restrained pearl-white core seated in rounded lavender-blue petals, crossed by one thin teal orbit band. A gentle warm-gold point at the center adds high-tier value. The shapes suggest restoration and deep mental calm without stars, eyes, faces, or cosmic scenery.
...
- One pearl-white central core
- A rounded lavender-blue petal cradle
- One thin teal orbit band
- A tiny restrained warm-gold center
...
- galaxy, night sky, eye symbol, floating stars, sharp lotus petals, or blinding bloom
