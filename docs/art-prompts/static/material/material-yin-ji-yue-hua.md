...
| Field | Value |
|---|---|
| Asset ID | `material.yin_ji_yue_hua` |
| Category | `material` |
| Output | `768 × 768` `transparent` PNG |
| Project target | `res://assets/materials/yin-ji-yue-hua.png` |
...
Composition:
A single moonlight condensate centered on transparent canvas. Seat one pearl-shaped droplet inside a broad crescent cradle, keeping both forms connected and the overall silhouette nearly circular. Do not add a night sky, stars, clouds, or orbiting particles.

Object and material design:
A pearl-white moonlight droplet resting in a rounded silver-blue crescent cradle, with muted lavender shadows and a tiny teal reflection. The material feels cool, quiet, and dense, using soft cel shading rather than glass realism or sparkling cosmic effects.
...
- One pearl-shaped moonlight droplet
- One broad connected silver-blue crescent cradle
- Muted lavender shadows
- A tiny restrained teal reflection
...
- night sky, stars, galaxy, sharp crescent points, glass realism, glitter, or blue neon
