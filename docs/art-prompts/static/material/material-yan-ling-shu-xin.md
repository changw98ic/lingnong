...
| Field | Value |
|---|---|
| Asset ID | `material.yan_ling_shu_xin` |
| Category | `material` |
| Output | `768 × 768` `transparent` PNG |
| Project target | `res://assets/materials/yan-ling-shu-xin.png` |
...
Composition:
A single heart-shaped tree core centered on transparent canvas and tilted slightly toward the viewer. Keep the outer bark shell intact around a visible inner core, with one small leaf shoot at the top and no detached embers.

Object and material design:
A rounded warm-brown tree heart with a coral-orange inner core, soft antique-gold growth rings, and one fresh jade shoot. The warmth appears as smooth internal color rather than open flame, char, sparks, or molten damage.
...
- One rounded warm-brown tree heart
- A visible coral-orange inner core
- Soft antique-gold growth rings
- One small fresh jade shoot
...
- open fire, embers, smoke, burnt bark, realistic wood grain, or anatomical heart imagery
